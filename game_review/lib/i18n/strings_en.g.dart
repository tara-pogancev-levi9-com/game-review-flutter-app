...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	late final TranslationsRatingsEn ratings = TranslationsRatingsEn.internal(_root);
	late final TranslationsGameStatusEn gameStatus = TranslationsGameStatusEn.internal(_root);
...
class TranslationsAppEn {
	...
	/// en: 'Game Review App'
	String get title => 'Game Review App';

	late final TranslationsAppBrandingEn branding = TranslationsAppBrandingEn.internal(_root);
}
...
class TranslationsGameDetailsEn {
	...
	String overallRecommendation({required Object percentage}) => '${percentage}% of players recommend this game';
	...
	/// en: 'Failed to share game: {{error}}'
	String failedToShareGame({required Object error}) => 'Failed to share game: ${error}';
}
...
class TranslationsReviewsEn {
	...
	String get completionStatusLabel => 'Completion status';
...
// Path: ratings
class TranslationsRatingsEn {
	TranslationsRatingsEn.internal(this._root);
...
// Path: gameStatus
class TranslationsGameStatusEn {
	TranslationsGameStatusEn.internal(this._root);
...
class TranslationsErrorsEn {
	...
	/// en: '{{field}} required'
	String requiredField({required Object field}) => '${field} required';
...
// Path: app.branding
class TranslationsAppBrandingEn {
	TranslationsAppBrandingEn.internal(this._root);
