...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,gameId,title,content,overallRating,gameplayRating,graphicsRating,storyRating,soundRating,valueRating,const DeepCollectionEquality().hash(pros),const DeepCollectionEquality().hash(cons),playtimeHours,completionStatus,recommended,createdAt,updatedAt,isLiked,likesCount,game,username]);

@override
String toString() {
  return 'ReviewModel(id: $id, userId: $userId, gameId: $gameId, title: $title, content: $content, overallRating: $overallRating, gameplayRating: $gameplayRating, graphicsRating: $graphicsRating, storyRating: $storyRating, soundRating: $soundRating, valueRating: $valueRating, pros: $pros, cons: $cons, playtimeHours: $playtimeHours, completionStatus: $completionStatus, recommended: $recommended, createdAt: $createdAt, updatedAt: $updatedAt, isLiked: $isLiked, likesCount: $likesCount, game: $game, username: $username)';
}
...
as int?,game: freezed == game ? _self.game : game // ignore: cast_nullable_to_non_nullable
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,gameId,title,content,overallRating,gameplayRating,graphicsRating,storyRating,soundRating,valueRating,const DeepCollectionEquality().hash(_pros),const DeepCollectionEquality().hash(_cons),playtimeHours,completionStatus,recommended,createdAt,updatedAt,isLiked,likesCount,game,username]);
